...
static void initialize_c2_Mondmission(SFc2_MondmissionInstanceStruct
  *chartInstance);
static void initialize_params_c2_Mondmission(SFc2_MondmissionInstanceStruct
  *chartInstance);
static void enable_c2_Mondmission(SFc2_MondmissionInstanceStruct *chartInstance);
static void disable_c2_Mondmission(SFc2_MondmissionInstanceStruct *chartInstance);
static void c2_update_debugger_state_c2_Mondmission
  (SFc2_MondmissionInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c2_Mondmission
  (SFc2_MondmissionInstanceStruct *chartInstance);
static void set_sim_state_c2_Mondmission(SFc2_MondmissionInstanceStruct
  *chartInstance, const mxArray *c2_st);
static void finalize_c2_Mondmission(SFc2_MondmissionInstanceStruct
  *chartInstance);
static void sf_gateway_c2_Mondmission(SFc2_MondmissionInstanceStruct
  *chartInstance);
static void mdl_start_c2_Mondmission(SFc2_MondmissionInstanceStruct
  *chartInstance);
static void initSimStructsc2_Mondmission(SFc2_MondmissionInstanceStruct
  *chartInstance);
static void init_script_number_translation(uint32_T c2_machineNumber, uint32_T
  c2_chartNumber, uint32_T c2_instanceNumber);
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData);
static void c2_emlrt_marshallIn(SFc2_MondmissionInstanceStruct *chartInstance,
  const mxArray *c2_b_v0welt, const char_T *c2_identifier, real_T c2_y[2]);
static void c2_b_emlrt_marshallIn(SFc2_MondmissionInstanceStruct *chartInstance,
  const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId, real_T c2_y[2]);
static void c2_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static const mxArray *c2_b_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static real_T c2_c_emlrt_marshallIn(SFc2_MondmissionInstanceStruct
...
static real_T c2_eml_xnrm2(SFc2_MondmissionInstanceStruct *chartInstance, real_T
  c2_x[2]);
static void c2_below_threshold(SFc2_MondmissionInstanceStruct *chartInstance);
static const mxArray *c2_c_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static int32_T c2_d_emlrt_marshallIn(SFc2_MondmissionInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static uint8_T c2_e_emlrt_marshallIn(SFc2_MondmissionInstanceStruct
  *chartInstance, const mxArray *c2_b_is_active_c2_Mondmission, const char_T
  *c2_identifier);
static uint8_T c2_f_emlrt_marshallIn(SFc2_MondmissionInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void init_dsm_address_info(SFc2_MondmissionInstanceStruct *chartInstance);
static void init_simulink_io_address(SFc2_MondmissionInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c2_is_active_c2_Mondmission = 0U;
}
  ...
  (SFc2_MondmissionInstanceStruct *chartInstance)
{
  ...
  c2_hoistedGlobal = chartInstance->c2_is_active_c2_Mondmission;
  ...
  *chartInstance, const mxArray *c2_st)
{
  ...
  chartInstance->c2_is_active_c2_Mondmission = c2_e_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c2_u, 1)),
     "is_active_c2_Mondmission");
  sf_mex_destroy(&c2_u);
  c2_update_debugger_state_c2_Mondmission(chartInstance);
...
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData)
{
  ...
  const mxArray *c2_y = NULL;
  SFc2_MondmissionInstanceStruct *chartInstance;
  chartInstance = (SFc2_MondmissionInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c2_Mondmission_get_eml_resolved_functions_info(void)
{
  ...
  *c2_identifier)
{
  ...
  c2_y = c2_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c2_b_is_active_c2_Mondmission), &c2_thisId);
  sf_mex_destroy(&c2_b_is_active_c2_Mondmission);
  return c2_y;
}
...
void sf_c2_Mondmission_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(1145926004U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(1411201028U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(694234064U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(2525484668U);
}

mxArray* sf_c2_Mondmission_get_post_codegen_info(void);
mxArray *sf_c2_Mondmission_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("n2wfu2wGx3lPEcutyELEIE");
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c2_Mondmission_get_post_codegen_info();
...
mxArray *sf_c2_Mondmission_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c2_Mondmission_jit_fallback_info(void)
{
...
mxArray *sf_c2_Mondmission_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c2_Mondmission(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"v0welt\",},{M[8],M[0],T\"is_active_c2_Mondmission\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c2_Mondmission_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc2_MondmissionInstanceStruct *) chartInfo->chartInstance;
...
{
  return "3ocxo1yG8bZsPa9uVuigFD";
}

static void sf_opaque_initialize_c2_Mondmission(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc2_MondmissionInstanceStruct*) chartInstanceVar)
    ->S,0);
  initialize_params_c2_Mondmission((SFc2_MondmissionInstanceStruct*)
    chartInstanceVar);
  initialize_c2_Mondmission((SFc2_MondmissionInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c2_Mondmission(void *chartInstanceVar)
{
  enable_c2_Mondmission((SFc2_MondmissionInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c2_Mondmission(void *chartInstanceVar)
{
  disable_c2_Mondmission((SFc2_MondmissionInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c2_Mondmission(void *chartInstanceVar)
{
  sf_gateway_c2_Mondmission((SFc2_MondmissionInstanceStruct*) chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c2_Mondmission(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  return get_sim_state_c2_Mondmission((SFc2_MondmissionInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c2_Mondmission(SimStruct* S, const mxArray
  *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  set_sim_state_c2_Mondmission((SFc2_MondmissionInstanceStruct*)
    chartInfo->chartInstance, st);
}

static void sf_opaque_terminate_c2_Mondmission(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc2_MondmissionInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c2_Mondmission((SFc2_MondmissionInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc2_Mondmission((SFc2_MondmissionInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c2_Mondmission(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c2_Mondmission(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
  ...
  ssSetChecksum0(S,(4006703029U));
  ssSetChecksum1(S,(2685491777U));
  ssSetChecksum2(S,(4130601272U));
  ssSetChecksum3(S,(1548766522U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c2_Mondmission(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c2_Mondmission(SimStruct *S)
{
  SFc2_MondmissionInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc2_MondmissionInstanceStruct *)utMalloc(sizeof
    (SFc2_MondmissionInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc2_MondmissionInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c2_Mondmission;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c2_Mondmission;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c2_Mondmission;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c2_Mondmission;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c2_Mondmission;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c2_Mondmission;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c2_Mondmission;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c2_Mondmission;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c2_Mondmission;
  chartInstance->chartInfo.mdlStart = mdlStart_c2_Mondmission;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c2_Mondmission;
...
void c2_Mondmission_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c2_Mondmission(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c2_Mondmission(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c2_Mondmission(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c2_Mondmission_method_dispatcher.\n"
