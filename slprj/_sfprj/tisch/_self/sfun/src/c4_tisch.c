...
static const char * c4_debug_family_names[8] = { "g", "FG", "nargin", "nargout",
  "m", "c", "l", "y" };
...
static void sf_gateway_c4_tisch(SFc4_tischInstanceStruct *chartInstance)
{
  ...
  c4_c_hoistedGlobal = *chartInstance->c4_l;
  c4_b_m = c4_hoistedGlobal;
  c4_b_c = c4_b_hoistedGlobal;
  c4_b_l = c4_c_hoistedGlobal;
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML(&c4_b_l, 6U, c4_sf_marshallOut);
  ...
  *chartInstance->c4_y = c4_b_y;
  ...
  _SFD_DATA_RANGE_CHECK(*chartInstance->c4_l, 3U);
}
