...
static const char * c2_debug_family_names[15] = { "g", "FG", "FF", "FD",
  "nargin", "nargout", "u", "m", "l", "c", "d", "x", "v1", "v2", "xpp" };
...
static void sf_gateway_c2_tisch(SFc2_tischInstanceStruct *chartInstance);
static void mdl_start_c2_tisch(SFc2_tischInstanceStruct *chartInstance);
...
static real_T c2_emlrt_marshallIn(SFc2_tischInstanceStruct *chartInstance, const
  mxArray *c2_b_xpp, const char_T *c2_identifier);
...
static void init_simulink_io_address(SFc2_tischInstanceStruct *chartInstance);
  ...
  *chartInstance)
{
  ...
  c2_hoistedGlobal = *chartInstance->c2_xpp;
  ...
  const mxArray *c2_st)
{
  ...
  *chartInstance->c2_xpp = c2_emlrt_marshallIn(chartInstance, sf_mex_dup
    (sf_mex_getcell(c2_b_u, 0)), "xpp");
  chartInstance->c2_is_active_c2_tisch = c2_d_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c2_b_u, 1)), "is_active_c2_tisch");
...
static void sf_gateway_c2_tisch(SFc2_tischInstanceStruct *chartInstance)
{
  ...
  c2_c_hoistedGlobal = *chartInstance->c2_l;
  c2_d_hoistedGlobal = *chartInstance->c2_c;
  c2_e_hoistedGlobal = *chartInstance->c2_d;
  c2_f_hoistedGlobal = *chartInstance->c2_x;
  c2_g_hoistedGlobal = *chartInstance->c2_v1;
  c2_h_hoistedGlobal = *chartInstance->c2_v2;
  c2_b_u = c2_hoistedGlobal;
  c2_b_m = c2_b_hoistedGlobal;
  c2_b_l = c2_c_hoistedGlobal;
  c2_b_c = c2_d_hoistedGlobal;
  c2_b_d = c2_e_hoistedGlobal;
  c2_b_x = c2_f_hoistedGlobal;
  c2_b_v1 = c2_g_hoistedGlobal;
  c2_b_v2 = c2_h_hoistedGlobal;
  _SFD_SYMBOL_SCOPE_PUSH_EML(0U, 15U, 15U, c2_debug_family_names,
    c2_debug_family_var_map);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c2_g, 0U, c2_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_FG, 1U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_FF, 2U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_FD, 3U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_nargout, 5U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c2_b_u, 6U, c2_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c2_b_m, 7U, c2_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c2_b_l, 8U, c2_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c2_b_c, 9U, c2_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c2_b_d, 10U, c2_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c2_b_x, 11U, c2_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c2_b_v1, 12U, c2_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c2_b_v2, 13U, c2_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_b_xpp, 14U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  CV_EML_FCN(0, 0);
  ...
  c2_FF = -(c2_b_c * ((c2_b_x - c2_b_u) - c2_b_l));
  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 7);
  c2_FD = c2_b_d * (c2_b_v1 + c2_b_v2);
  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 9);
  c2_A = 2.0 * (c2_FF - c2_FD) - c2_FG;
  c2_B = c2_b_m;
  c2_c_x = c2_A;
  c2_y = c2_B;
  c2_d_x = c2_c_x;
  ...
  c2_e_x = c2_d_x;
  c2_c_y = c2_b_y;
  c2_b_xpp = c2_e_x / c2_c_y;
  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, -9);
  _SFD_SYMBOL_SCOPE_POP();
  *chartInstance->c2_xpp = c2_b_xpp;
  _SFD_CC_CALL(EXIT_OUT_OF_FUNCTION_TAG, 1U, chartInstance->c2_sfEvent);
  _SFD_SYMBOL_SCOPE_POP();
  _SFD_CHECK_FOR_STATE_INCONSISTENCY(_tischMachineNumber_,
    chartInstance->chartNumber, chartInstance->instanceNumber);
  _SFD_DATA_RANGE_CHECK(*chartInstance->c2_xpp, 1U);
  _SFD_DATA_RANGE_CHECK(*chartInstance->c2_m, 2U);
  _SFD_DATA_RANGE_CHECK(*chartInstance->c2_l, 3U);
  _SFD_DATA_RANGE_CHECK(*chartInstance->c2_c, 4U);
  _SFD_DATA_RANGE_CHECK(*chartInstance->c2_d, 5U);
  _SFD_DATA_RANGE_CHECK(*chartInstance->c2_x, 6U);
  _SFD_DATA_RANGE_CHECK(*chartInstance->c2_v1, 7U);
  _SFD_DATA_RANGE_CHECK(*chartInstance->c2_v2, 8U);
}
  ...
  mxArray *c2_b_xpp, const char_T *c2_identifier)
{
  ...
  c2_y = c2_b_emlrt_marshallIn(chartInstance, sf_mex_dup(c2_b_xpp), &c2_thisId);
  sf_mex_destroy(&c2_b_xpp);
  return c2_y;
}
...
static void c2_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData)
{
  const mxArray *c2_b_xpp;
  const char_T *c2_identifier;
  emlrtMsgIdentifier c2_thisId;
  real_T c2_y;
  SFc2_tischInstanceStruct *chartInstance;
  chartInstance = (SFc2_tischInstanceStruct *)chartInstanceVoid;
  c2_b_xpp = sf_mex_dup(c2_mxArrayInData);
...
static void init_simulink_io_address(SFc2_tischInstanceStruct *chartInstance)
{
  chartInstance->c2_u = (real_T *)ssGetInputPortSignal_wrapper(chartInstance->S,
    0);
  chartInstance->c2_xpp = (real_T *)ssGetOutputPortSignal_wrapper
    (chartInstance->S, 1);
  chartInstance->c2_m = (real_T *)ssGetInputPortSignal_wrapper(chartInstance->S,
    1);
  chartInstance->c2_l = (real_T *)ssGetInputPortSignal_wrapper(chartInstance->S,
    2);
  ...
  chartInstance->c2_x = (real_T *)ssGetInputPortSignal_wrapper(chartInstance->S,
    5);
  chartInstance->c2_v1 = (real_T *)ssGetInputPortSignal_wrapper(chartInstance->S,
    6);
  chartInstance->c2_v2 = (real_T *)ssGetInputPortSignal_wrapper(chartInstance->S,
    7);
}
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(3342405938U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(1047260689U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2336524197U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(3363071858U);
}

mxArray* sf_c2_tisch_get_post_codegen_info(void);
mxArray *sf_c2_tisch_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("mul3sdWNF2sX2vuifgXrTH");
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c2_tisch_get_post_codegen_info();
...
mxArray *sf_c2_tisch_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c2_tisch_jit_fallback_info(void)
{
...
mxArray *sf_c2_tisch_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c2_tisch(void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"xpp\",},{M[8],M[0],T\"is_active_c2_tisch\",}}"
  };
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc2_tischInstanceStruct *) chartInfo->chartInstance;
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        if (chartAlreadyPresent==0) {
          ...
          _SFD_SET_DATA_PROPS(7,1,1,0,"v1");
          _SFD_SET_DATA_PROPS(8,1,1,0,"v2");
        ...
        _SFD_SET_DATA_VALUE_PTR(1U, chartInstance->c2_xpp);
        _SFD_SET_DATA_VALUE_PTR(2U, chartInstance->c2_m);
        _SFD_SET_DATA_VALUE_PTR(3U, chartInstance->c2_l);
        _SFD_SET_DATA_VALUE_PTR(4U, chartInstance->c2_c);
        _SFD_SET_DATA_VALUE_PTR(5U, chartInstance->c2_d);
        _SFD_SET_DATA_VALUE_PTR(6U, chartInstance->c2_x);
        _SFD_SET_DATA_VALUE_PTR(7U, chartInstance->c2_v1);
        _SFD_SET_DATA_VALUE_PTR(8U, chartInstance->c2_v2);
      }
    } else {
...
{
  sf_gateway_c2_tisch((SFc2_tischInstanceStruct*) chartInstanceVar);
}
...
static const mxArray* sf_opaque_get_sim_state_c2_tisch(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  return get_sim_state_c2_tisch((SFc2_tischInstanceStruct*)
...
static void sf_opaque_set_sim_state_c2_tisch(SimStruct* S, const mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  set_sim_state_c2_tisch((SFc2_tischInstanceStruct*)chartInfo->chartInstance, st);
}
...
static void mdlProcessParameters_c2_tisch(SimStruct *S)
{
  ...
  if (sf_machine_global_initializer_called()) {
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
    initialize_params_c2_tisch((SFc2_tischInstanceStruct*)
...
static void mdlSetWorkWidths_c2_tisch(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(2413836913U));
  ssSetChecksum1(S,(1779667081U));
  ssSetChecksum2(S,(378604683U));
  ssSetChecksum3(S,(4252518201U));
...
static void mdlStart_c2_tisch(SimStruct *S)
{
  ...
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc2_tischInstanceStruct *)utMalloc(sizeof
