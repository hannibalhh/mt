...
static void sf_gateway_c1_Erdorbits(SFc1_ErdorbitsInstanceStruct *chartInstance);
static void mdl_start_c1_Erdorbits(SFc1_ErdorbitsInstanceStruct *chartInstance);
...
static void init_simulink_io_address(SFc1_ErdorbitsInstanceStruct *chartInstance);
...
static void sf_gateway_c1_Erdorbits(SFc1_ErdorbitsInstanceStruct *chartInstance)
{
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML(&c1_b_h, 7U, c1_b_sf_marshallOut);
...
static void init_simulink_io_address(SFc1_ErdorbitsInstanceStruct *chartInstance)
{
  ...
  chartInstance->c1_x0 = (real_T (*)[2])ssGetOutputPortSignal_wrapper
    (chartInstance->S, 1);
  chartInstance->c1_h = (real_T *)ssGetInputPortSignal_wrapper(chartInstance->S,
    1);
}
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(216701757U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(2090934331U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2390782249U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(4161444158U);
}

mxArray* sf_c1_Erdorbits_get_post_codegen_info(void);
mxArray *sf_c1_Erdorbits_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("z57mwCjCtttj4qpZSbZB8C");
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c1_Erdorbits_get_post_codegen_info();
...
mxArray *sf_c1_Erdorbits_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c1_Erdorbits_jit_fallback_info(void)
{
...
mxArray *sf_c1_Erdorbits_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c1_Erdorbits(void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"x0\",},{M[8],M[0],T\"is_active_c1_Erdorbits\",}}"
  };
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc1_ErdorbitsInstanceStruct *) chartInfo->chartInstance;
...
{
  sf_gateway_c1_Erdorbits((SFc1_ErdorbitsInstanceStruct*) chartInstanceVar);
}
...
static const mxArray* sf_opaque_get_sim_state_c1_Erdorbits(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  return get_sim_state_c1_Erdorbits((SFc1_ErdorbitsInstanceStruct*)
...
static void mdlSetWorkWidths_c1_Erdorbits(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(1886868448U));
  ssSetChecksum1(S,(1574842811U));
  ssSetChecksum2(S,(3363882817U));
  ssSetChecksum3(S,(1623907547U));
...
static void mdlStart_c1_Erdorbits(SimStruct *S)
{
  ...
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc1_ErdorbitsInstanceStruct *)utMalloc(sizeof
