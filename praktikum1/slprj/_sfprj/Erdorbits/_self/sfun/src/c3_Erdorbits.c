...
static const char * c3_debug_family_names[8] = { "G", "m_Erde", "r_Erde",
  "richtung", "nargin", "nargout", "x0", "a" };
...
static void sf_gateway_c3_Erdorbits(SFc3_ErdorbitsInstanceStruct *chartInstance);
static void mdl_start_c3_Erdorbits(SFc3_ErdorbitsInstanceStruct *chartInstance);
...
static real_T c3_eml_xnrm2(SFc3_ErdorbitsInstanceStruct *chartInstance, real_T
  c3_x[2]);
static void c3_below_threshold(SFc3_ErdorbitsInstanceStruct *chartInstance);
...
static void init_simulink_io_address(SFc3_ErdorbitsInstanceStruct *chartInstance);
...
static void sf_gateway_c3_Erdorbits(SFc3_ErdorbitsInstanceStruct *chartInstance)
{
  ...
  for (c3_i3 = 0; c3_i3 < 2; c3_i3++) {
    c3_b_x0[c3_i3] = (*chartInstance->c3_x0)[c3_i3];
  }
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_r_Erde, 2U, c3_b_sf_marshallOut,
    c3_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c3_richtung, 3U, c3_sf_marshallOut,
    c3_sf_marshallIn);
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_nargout, 5U, c3_b_sf_marshallOut,
    c3_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(c3_b_x0, 6U, c3_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c3_b_a, 7U, c3_sf_marshallOut,
    c3_sf_marshallIn);
  CV_EML_FCN(0, 0);
  ...
  for (c3_i7 = 0; c3_i7 < 2; c3_i7++) {
    c3_richtung[c3_i7] = c3_x[c3_i7] / c3_c_y;
  }
  ...
  c3_e_y = c3_d_y;
  c3_f_y = c3_e_y;
  c3_g_y = 3.9353E+14 / c3_f_y;
  for (c3_i8 = 0; c3_i8 < 2; c3_i8++) {
    c3_x[c3_i8] = c3_richtung[c3_i8];
  }

  c3_b = c3_g_y;
  for (c3_i9 = 0; c3_i9 < 2; c3_i9++) {
    c3_b_a[c3_i9] = c3_x[c3_i9] * c3_b;
  }

  sf_mex_printf("%s =\\n", "a");
  for (c3_i10 = 0; c3_i10 < 2; c3_i10++) {
    c3_u[c3_i10] = c3_b_a[c3_i10];
  }

  c3_h_y = NULL;
  sf_mex_assign(&c3_h_y, sf_mex_create("y", c3_u, 0, 0U, 1U, 0U, 1, 2), false);
  sf_mex_call_debug(sfGlobalDebugInstanceStruct, "disp", 0U, 1U, 14, c3_h_y);
  _SFD_EML_CALL(0U, chartInstance->c3_sfEvent, -11);
  _SFD_SYMBOL_SCOPE_POP();
  for (c3_i11 = 0; c3_i11 < 2; c3_i11++) {
    (*chartInstance->c3_a)[c3_i11] = c3_b_a[c3_i11];
  }
  ...
  for (c3_i12 = 0; c3_i12 < 2; c3_i12++) {
    _SFD_DATA_RANGE_CHECK((*chartInstance->c3_a)[c3_i12], 1U);
  }
}
...
static const mxArray *c3_sf_marshallOut(void *chartInstanceVoid, void *c3_inData)
{
  ...
  for (c3_i13 = 0; c3_i13 < 2; c3_i13++) {
    c3_b_inData[c3_i13] = (*(real_T (*)[2])c3_inData)[c3_i13];
  }
  ...
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData)
{
  ...
  for (c3_i16 = 0; c3_i16 < 2; c3_i16++) {
    (*(real_T (*)[2])c3_outData)[c3_i16] = c3_y[c3_i16];
  }
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(317210346U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(2456438692U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2026056841U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(3107883572U);
}

mxArray* sf_c3_Erdorbits_get_post_codegen_info(void);
mxArray *sf_c3_Erdorbits_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("CDhUvjJG2EMcybUrUdle1B");
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c3_Erdorbits_get_post_codegen_info();
...
mxArray *sf_c3_Erdorbits_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c3_Erdorbits_jit_fallback_info(void)
{
...
mxArray *sf_c3_Erdorbits_updateBuildInfo_args_info(void)
{
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc3_ErdorbitsInstanceStruct *) chartInfo->chartInstance;
...
{
  sf_gateway_c3_Erdorbits((SFc3_ErdorbitsInstanceStruct*) chartInstanceVar);
}
...
static const mxArray* sf_opaque_get_sim_state_c3_Erdorbits(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  return get_sim_state_c3_Erdorbits((SFc3_ErdorbitsInstanceStruct*)
...
static void mdlSetWorkWidths_c3_Erdorbits(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(2077229021U));
  ssSetChecksum1(S,(2330447152U));
  ssSetChecksum2(S,(576496028U));
  ssSetChecksum3(S,(1082063869U));
...
static void mdlStart_c3_Erdorbits(SimStruct *S)
{
  ...
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc3_ErdorbitsInstanceStruct *)utMalloc(sizeof
