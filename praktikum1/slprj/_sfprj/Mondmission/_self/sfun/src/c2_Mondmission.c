...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(703526194U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(645518875U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(1756933117U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(3395129646U);
}
...
mxArray *sf_c2_Mondmission_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("PgvDgtXM33zX2RAXaau6RC");
...
static void mdlSetWorkWidths_c2_Mondmission(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(892661157U));
  ssSetChecksum1(S,(1540265555U));
  ssSetChecksum2(S,(2652737563U));
  ssSetChecksum3(S,(1163703900U));
