...
static void initialize_c4_Mondmission(SFc4_MondmissionInstanceStruct
  *chartInstance);
static void initialize_params_c4_Mondmission(SFc4_MondmissionInstanceStruct
  *chartInstance);
static void enable_c4_Mondmission(SFc4_MondmissionInstanceStruct *chartInstance);
static void disable_c4_Mondmission(SFc4_MondmissionInstanceStruct *chartInstance);
static void c4_update_debugger_state_c4_Mondmission
  (SFc4_MondmissionInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c4_Mondmission
  (SFc4_MondmissionInstanceStruct *chartInstance);
static void set_sim_state_c4_Mondmission(SFc4_MondmissionInstanceStruct
  *chartInstance, const mxArray *c4_st);
static void finalize_c4_Mondmission(SFc4_MondmissionInstanceStruct
  *chartInstance);
static void sf_gateway_c4_Mondmission(SFc4_MondmissionInstanceStruct
  *chartInstance);
static void mdl_start_c4_Mondmission(SFc4_MondmissionInstanceStruct
  *chartInstance);
static void initSimStructsc4_Mondmission(SFc4_MondmissionInstanceStruct
  *chartInstance);
static void init_script_number_translation(uint32_T c4_machineNumber, uint32_T
  c4_chartNumber, uint32_T c4_instanceNumber);
static const mxArray *c4_sf_marshallOut(void *chartInstanceVoid, void *c4_inData);
static real_T c4_emlrt_marshallIn(SFc4_MondmissionInstanceStruct *chartInstance,
  const mxArray *c4_b_y, const char_T *c4_identifier);
static real_T c4_b_emlrt_marshallIn(SFc4_MondmissionInstanceStruct
...
static real_T c4_eml_xnrm2(SFc4_MondmissionInstanceStruct *chartInstance, real_T
  c4_x[2]);
static void c4_below_threshold(SFc4_MondmissionInstanceStruct *chartInstance);
static const mxArray *c4_c_sf_marshallOut(void *chartInstanceVoid, void
  *c4_inData);
static int32_T c4_c_emlrt_marshallIn(SFc4_MondmissionInstanceStruct
  *chartInstance, const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId);
static void c4_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c4_mxArrayInData, const char_T *c4_varName, void *c4_outData);
static uint8_T c4_d_emlrt_marshallIn(SFc4_MondmissionInstanceStruct
  *chartInstance, const mxArray *c4_b_is_active_c4_Mondmission, const char_T
  *c4_identifier);
static uint8_T c4_e_emlrt_marshallIn(SFc4_MondmissionInstanceStruct
  *chartInstance, const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId);
static void init_dsm_address_info(SFc4_MondmissionInstanceStruct *chartInstance);
static void init_simulink_io_address(SFc4_MondmissionInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c4_is_active_c4_Mondmission = 0U;
}
  ...
  (SFc4_MondmissionInstanceStruct *chartInstance)
{
  ...
  c4_b_hoistedGlobal = chartInstance->c4_is_active_c4_Mondmission;
  ...
  *chartInstance, const mxArray *c4_st)
{
  ...
  *chartInstance->c4_y = c4_emlrt_marshallIn(chartInstance, sf_mex_dup
  ...
  chartInstance->c4_is_active_c4_Mondmission = c4_d_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c4_u, 1)),
     "is_active_c4_Mondmission");
  sf_mex_destroy(&c4_u);
  c4_update_debugger_state_c4_Mondmission(chartInstance);
...
static const mxArray *c4_sf_marshallOut(void *chartInstanceVoid, void *c4_inData)
{
  ...
  const mxArray *c4_b_y = NULL;
  SFc4_MondmissionInstanceStruct *chartInstance;
  chartInstance = (SFc4_MondmissionInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c4_Mondmission_get_eml_resolved_functions_info(void)
{
  ...
  *c4_identifier)
{
  ...
  c4_b_y = c4_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c4_b_is_active_c4_Mondmission), &c4_thisId);
  sf_mex_destroy(&c4_b_is_active_c4_Mondmission);
  return c4_b_y;
}
...
void sf_c4_Mondmission_get_check_sum(mxArray *plhs[])
{
...
mxArray* sf_c4_Mondmission_get_post_codegen_info(void);
mxArray *sf_c4_Mondmission_get_autoinheritance_info(void)
{
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c4_Mondmission_get_post_codegen_info();
...
mxArray *sf_c4_Mondmission_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c4_Mondmission_jit_fallback_info(void)
{
...
mxArray *sf_c4_Mondmission_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c4_Mondmission(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"y\",},{M[8],M[0],T\"is_active_c4_Mondmission\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c4_Mondmission_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc4_MondmissionInstanceStruct *) chartInfo->chartInstance;
...
static void sf_opaque_initialize_c4_Mondmission(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc4_MondmissionInstanceStruct*) chartInstanceVar)
    ->S,0);
  initialize_params_c4_Mondmission((SFc4_MondmissionInstanceStruct*)
    chartInstanceVar);
  initialize_c4_Mondmission((SFc4_MondmissionInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c4_Mondmission(void *chartInstanceVar)
{
  enable_c4_Mondmission((SFc4_MondmissionInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c4_Mondmission(void *chartInstanceVar)
{
  disable_c4_Mondmission((SFc4_MondmissionInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c4_Mondmission(void *chartInstanceVar)
{
  sf_gateway_c4_Mondmission((SFc4_MondmissionInstanceStruct*) chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c4_Mondmission(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  return get_sim_state_c4_Mondmission((SFc4_MondmissionInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c4_Mondmission(SimStruct* S, const mxArray
  *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  set_sim_state_c4_Mondmission((SFc4_MondmissionInstanceStruct*)
    chartInfo->chartInstance, st);
}

static void sf_opaque_terminate_c4_Mondmission(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc4_MondmissionInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c4_Mondmission((SFc4_MondmissionInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc4_Mondmission((SFc4_MondmissionInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c4_Mondmission(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c4_Mondmission(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c4_Mondmission(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c4_Mondmission(SimStruct *S)
{
  SFc4_MondmissionInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc4_MondmissionInstanceStruct *)utMalloc(sizeof
    (SFc4_MondmissionInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc4_MondmissionInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c4_Mondmission;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c4_Mondmission;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c4_Mondmission;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c4_Mondmission;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c4_Mondmission;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c4_Mondmission;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c4_Mondmission;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c4_Mondmission;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c4_Mondmission;
  chartInstance->chartInfo.mdlStart = mdlStart_c4_Mondmission;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c4_Mondmission;
...
void c4_Mondmission_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c4_Mondmission(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c4_Mondmission(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c4_Mondmission(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c4_Mondmission_method_dispatcher.\n"
