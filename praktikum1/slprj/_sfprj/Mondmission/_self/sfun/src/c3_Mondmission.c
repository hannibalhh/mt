...
#include <stddef.h>
#include "blas.h"
#include "Mondmission_sfun.h"
#include "c3_Mondmission.h"
#include "mwmathutil.h"
#define CHARTINSTANCE_CHARTNUMBER      (chartInstance->chartNumber)
#define CHARTINSTANCE_INSTANCENUMBER   (chartInstance->instanceNumber)
#include "Mondmission_sfun_debug_macros.h"
...
static const char * c3_debug_family_names[14] = { "G", "m_Erde", "x_Mond",
  "m_Mond", "v_Mond", "r_Erde", "r_Mond", "richtungE", "richtungM", "a_Mond",
  "nargin", "nargout", "x0", "a" };

/* Function Declarations */
static void initialize_c3_Mondmission(SFc3_MondmissionInstanceStruct
  *chartInstance);
static void initialize_params_c3_Mondmission(SFc3_MondmissionInstanceStruct
  *chartInstance);
static void enable_c3_Mondmission(SFc3_MondmissionInstanceStruct *chartInstance);
static void disable_c3_Mondmission(SFc3_MondmissionInstanceStruct *chartInstance);
static void c3_update_debugger_state_c3_Mondmission
  (SFc3_MondmissionInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c3_Mondmission
  (SFc3_MondmissionInstanceStruct *chartInstance);
static void set_sim_state_c3_Mondmission(SFc3_MondmissionInstanceStruct
  *chartInstance, const mxArray *c3_st);
static void finalize_c3_Mondmission(SFc3_MondmissionInstanceStruct
  *chartInstance);
static void sf_gateway_c3_Mondmission(SFc3_MondmissionInstanceStruct
  *chartInstance);
static void mdl_start_c3_Mondmission(SFc3_MondmissionInstanceStruct
  *chartInstance);
static void c3_chartstep_c3_Mondmission(SFc3_MondmissionInstanceStruct
  *chartInstance);
static void initSimStructsc3_Mondmission(SFc3_MondmissionInstanceStruct
  *chartInstance);
static void init_script_number_translation(uint32_T c3_machineNumber, uint32_T
  c3_chartNumber, uint32_T c3_instanceNumber);
static const mxArray *c3_sf_marshallOut(void *chartInstanceVoid, void *c3_inData);
static void c3_emlrt_marshallIn(SFc3_MondmissionInstanceStruct *chartInstance,
  const mxArray *c3_b_a, const char_T *c3_identifier, real_T c3_y[2]);
static void c3_b_emlrt_marshallIn(SFc3_MondmissionInstanceStruct *chartInstance,
  const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId, real_T c3_y[2]);
static void c3_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData);
static const mxArray *c3_b_sf_marshallOut(void *chartInstanceVoid, void
  *c3_inData);
static real_T c3_c_emlrt_marshallIn(SFc3_MondmissionInstanceStruct
...
static void c3_eml_scalar_eg(SFc3_MondmissionInstanceStruct *chartInstance);
static real_T c3_eml_xnrm2(SFc3_MondmissionInstanceStruct *chartInstance, real_T
  c3_x[2]);
static void c3_below_threshold(SFc3_MondmissionInstanceStruct *chartInstance);
static real_T c3_mpower(SFc3_MondmissionInstanceStruct *chartInstance, real_T
  c3_b_a);
static const mxArray *c3_c_sf_marshallOut(void *chartInstanceVoid, void
  *c3_inData);
static int32_T c3_d_emlrt_marshallIn(SFc3_MondmissionInstanceStruct
  *chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
static void c3_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData);
static uint8_T c3_e_emlrt_marshallIn(SFc3_MondmissionInstanceStruct
  *chartInstance, const mxArray *c3_b_is_active_c3_Mondmission, const char_T
  *c3_identifier);
static uint8_T c3_f_emlrt_marshallIn(SFc3_MondmissionInstanceStruct
  *chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
static void init_dsm_address_info(SFc3_MondmissionInstanceStruct *chartInstance);
static void init_simulink_io_address(SFc3_MondmissionInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c3_is_active_c3_Mondmission = 0U;
}
  ...
  (SFc3_MondmissionInstanceStruct *chartInstance)
{
  ...
  for (c3_i0 = 0; c3_i0 < 2; c3_i0++) {
    c3_u[c3_i0] = (*chartInstance->c3_a)[c3_i0];
  }

  c3_b_y = NULL;
  sf_mex_assign(&c3_b_y, sf_mex_create("y", c3_u, 0, 0U, 1U, 0U, 1, 2), false);
  sf_mex_setcell(c3_y, 0, c3_b_y);
  c3_hoistedGlobal = chartInstance->c3_is_active_c3_Mondmission;
  ...
  *chartInstance, const mxArray *c3_st)
{
  ...
  for (c3_i1 = 0; c3_i1 < 2; c3_i1++) {
    (*chartInstance->c3_a)[c3_i1] = c3_dv0[c3_i1];
  }

  chartInstance->c3_is_active_c3_Mondmission = c3_e_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c3_u, 1)),
     "is_active_c3_Mondmission");
  sf_mex_destroy(&c3_u);
  c3_update_debugger_state_c3_Mondmission(chartInstance);
  ...
  *chartInstance)
{
  ...
  for (c3_i2 = 0; c3_i2 < 2; c3_i2++) {
    _SFD_DATA_RANGE_CHECK((*chartInstance->c3_x0)[c3_i2], 0U);
  }

  chartInstance->c3_sfEvent = CALL_EVENT;
  c3_chartstep_c3_Mondmission(chartInstance);
  _SFD_SYMBOL_SCOPE_POP();
  _SFD_CHECK_FOR_STATE_INCONSISTENCY(_MondmissionMachineNumber_,
    chartInstance->chartNumber, chartInstance->instanceNumber);
  for (c3_i3 = 0; c3_i3 < 2; c3_i3++) {
    _SFD_DATA_RANGE_CHECK((*chartInstance->c3_a)[c3_i3], 1U);
  }
}
  ...
  *chartInstance)
{
  ...
  real_T c3_r_Erde;
  real_T c3_r_Mond;
  real_T c3_richtungE[2];
  real_T c3_richtungM[2];
  real_T c3_a_Mond[2];
  ...
  for (c3_i4 = 0; c3_i4 < 2; c3_i4++) {
    c3_b_x0[c3_i4] = (*chartInstance->c3_x0)[c3_i4];
  }

  _SFD_SYMBOL_SCOPE_PUSH_EML(0U, 14U, 14U, c3_debug_family_names,
    c3_debug_family_var_map);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c3_G, 0U, c3_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c3_m_Erde, 1U, c3_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c3_x_Mond, 2U, c3_sf_marshallOut,
    c3_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c3_m_Mond, 3U, c3_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c3_v_Mond, 4U, c3_sf_marshallOut,
    c3_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_r_Erde, 5U, c3_b_sf_marshallOut,
    c3_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_r_Mond, 6U, c3_b_sf_marshallOut,
    c3_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c3_richtungE, 7U, c3_sf_marshallOut,
    c3_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c3_richtungM, 8U, c3_sf_marshallOut,
    c3_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c3_a_Mond, 9U, c3_sf_marshallOut,
    c3_sf_marshallIn);
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_nargout, 11U, c3_b_sf_marshallOut,
    c3_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(c3_b_x0, 12U, c3_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c3_b_a, 13U, c3_sf_marshallOut,
    c3_sf_marshallIn);
  CV_EML_FCN(0, 0);
  _SFD_EML_CALL(0U, chartInstance->c3_sfEvent, 6);
  c3_G = 6.6743E-11;
  _SFD_EML_CALL(0U, chartInstance->c3_sfEvent, 7);
  c3_m_Erde = 5.9736000000000006E+24;
  _SFD_EML_CALL(0U, chartInstance->c3_sfEvent, 9);
  for (c3_i5 = 0; c3_i5 < 2; c3_i5++) {
    c3_x_Mond[c3_i5] = -3.8E+8 * (real_T)c3_i5;
  }

  sf_mex_printf("%s =\\n", "x_Mond");
  for (c3_i6 = 0; c3_i6 < 2; c3_i6++) {
    c3_u[c3_i6] = c3_x_Mond[c3_i6];
  }
  ...
  for (c3_i7 = 0; c3_i7 < 2; c3_i7++) {
    c3_v_Mond[c3_i7] = c3_b_x0[c3_i7] - c3_x_Mond[c3_i7];
  }

  _SFD_EML_CALL(0U, chartInstance->c3_sfEvent, 14);
  for (c3_i8 = 0; c3_i8 < 2; c3_i8++) {
    c3_x[c3_i8] = c3_b_x0[c3_i8];
  }

  for (c3_i9 = 0; c3_i9 < 2; c3_i9++) {
    c3_b_x[c3_i9] = c3_x[c3_i9];
  }

  c3_r_Erde = c3_eml_xnrm2(chartInstance, c3_b_x);
  _SFD_EML_CALL(0U, chartInstance->c3_sfEvent, 15);
  for (c3_i10 = 0; c3_i10 < 2; c3_i10++) {
    c3_x[c3_i10] = c3_v_Mond[c3_i10];
  }

  for (c3_i11 = 0; c3_i11 < 2; c3_i11++) {
    c3_c_x[c3_i11] = c3_x[c3_i11];
  }

  c3_r_Mond = c3_eml_xnrm2(chartInstance, c3_c_x);
  _SFD_EML_CALL(0U, chartInstance->c3_sfEvent, 17);
  for (c3_i12 = 0; c3_i12 < 2; c3_i12++) {
    c3_x[c3_i12] = -c3_b_x0[c3_i12];
  }
  ...
  for (c3_i13 = 0; c3_i13 < 2; c3_i13++) {
    c3_richtungE[c3_i13] = c3_x[c3_i13] / c3_d_y;
  }

  _SFD_EML_CALL(0U, chartInstance->c3_sfEvent, 18);
  for (c3_i14 = 0; c3_i14 < 2; c3_i14++) {
    c3_x[c3_i14] = -c3_v_Mond[c3_i14];
  }
  ...
  for (c3_i15 = 0; c3_i15 < 2; c3_i15++) {
    c3_richtungM[c3_i15] = c3_x[c3_i15] / c3_g_y;
  }

  _SFD_EML_CALL(0U, chartInstance->c3_sfEvent, 20);
  for (c3_i16 = 0; c3_i16 < 2; c3_i16++) {
    c3_x[c3_i16] = c3_richtungM[c3_i16];
  }

  for (c3_i17 = 0; c3_i17 < 2; c3_i17++) {
    c3_x[c3_i17] *= 6.6743E-11;
  }

  for (c3_i18 = 0; c3_i18 < 2; c3_i18++) {
    c3_x[c3_i18] *= 7.348E+22;
  }

  c3_c_B = c3_mpower(chartInstance, c3_r_Mond);
  c3_h_y = c3_c_B;
  c3_i_y = c3_h_y;
  c3_j_y = c3_i_y;
  for (c3_i19 = 0; c3_i19 < 2; c3_i19++) {
    c3_a_Mond[c3_i19] = c3_x[c3_i19] / c3_j_y;
  }

  sf_mex_printf("%s =\\n", "a_Mond");
  for (c3_i20 = 0; c3_i20 < 2; c3_i20++) {
    c3_b_u[c3_i20] = c3_a_Mond[c3_i20];
  }

  c3_k_y = NULL;
  sf_mex_assign(&c3_k_y, sf_mex_create("y", c3_b_u, 0, 0U, 1U, 0U, 1, 2), false);
  sf_mex_call_debug(sfGlobalDebugInstanceStruct, "disp", 0U, 1U, 14, c3_k_y);
  _SFD_EML_CALL(0U, chartInstance->c3_sfEvent, 21);
  for (c3_i21 = 0; c3_i21 < 2; c3_i21++) {
    c3_x[c3_i21] = c3_richtungE[c3_i21];
  }

  for (c3_i22 = 0; c3_i22 < 2; c3_i22++) {
    c3_x[c3_i22] *= 6.6743E-11;
  }

  for (c3_i23 = 0; c3_i23 < 2; c3_i23++) {
    c3_x[c3_i23] *= 5.9736000000000006E+24;
  }

  c3_d_B = c3_mpower(chartInstance, c3_r_Erde);
  c3_l_y = c3_d_B;
  c3_m_y = c3_l_y;
  c3_n_y = c3_m_y;
  ...
  for (c3_i25 = 0; c3_i25 < 2; c3_i25++) {
    c3_b_a[c3_i25] = c3_x[c3_i25] + c3_a_Mond[c3_i25];
  }

  _SFD_EML_CALL(0U, chartInstance->c3_sfEvent, -21);
  _SFD_SYMBOL_SCOPE_POP();
  for (c3_i26 = 0; c3_i26 < 2; c3_i26++) {
    (*chartInstance->c3_a)[c3_i26] = c3_b_a[c3_i26];
  }
...
static const mxArray *c3_sf_marshallOut(void *chartInstanceVoid, void *c3_inData)
{
  ...
  const mxArray *c3_y = NULL;
  SFc3_MondmissionInstanceStruct *chartInstance;
  chartInstance = (SFc3_MondmissionInstanceStruct *)chartInstanceVoid;
  ...
  const mxArray *c3_b_a, const char_T *c3_identifier, real_T c3_y[2])
{
  ...
  c3_b_emlrt_marshallIn(chartInstance, sf_mex_dup(c3_b_a), &c3_thisId, c3_y);
  sf_mex_destroy(&c3_b_a);
}
  ...
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData)
{
  ...
  SFc3_MondmissionInstanceStruct *chartInstance;
  chartInstance = (SFc3_MondmissionInstanceStruct *)chartInstanceVoid;
  c3_b_a = sf_mex_dup(c3_mxArrayInData);
  ...
  for (c3_i30 = 0; c3_i30 < 2; c3_i30++) {
    (*(real_T (*)[2])c3_outData)[c3_i30] = c3_y[c3_i30];
  }
...
const mxArray *sf_c3_Mondmission_get_eml_resolved_functions_info(void)
{
...
static void c3_info_helper(const mxArray **c3_info)
{
  ...
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_int_forloop_overflow_check.m!eml_int_forloop_overflow_check_helper"),
                  "context", "context", 30);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("isfi"), "name", "name", 30);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("coder.internal.indexInt"),
  ...
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/coder/coder/+coder/+internal/+refblas/xnrm2.p"),
                  "context", "context", 36);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("abs"), "name", "name", 36);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 36);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c3_info, sf_mex_duplicatearraysafe(&c3_lhs38), "lhs", "lhs",
                  38);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(""), "context", "context", 39);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("mrdivide"), "name", "name", 39);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 39);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/mrdivide.p"), "context",
                  "context", 41);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("rdivide"), "name", "name", 41);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 41);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/rdivide.m"), "context",
                  "context", 44);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("eml_div"), "name", "name", 44);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 44);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
  ...
  *c3_identifier)
{
  ...
  c3_y = c3_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c3_b_is_active_c3_Mondmission), &c3_thisId);
  sf_mex_destroy(&c3_b_is_active_c3_Mondmission);
  return c3_y;
}
...
static void init_simulink_io_address(SFc3_MondmissionInstanceStruct
  *chartInstance)
{
  chartInstance->c3_x0 = (real_T (*)[2])ssGetInputPortSignal_wrapper
    (chartInstance->S, 0);
  chartInstance->c3_a = (real_T (*)[2])ssGetOutputPortSignal_wrapper
    (chartInstance->S, 1);
}
...
void sf_c3_Mondmission_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(3418996829U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(3894918992U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(656779343U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(2953332379U);
}

mxArray* sf_c3_Mondmission_get_post_codegen_info(void);
mxArray *sf_c3_Mondmission_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("nb0BSFYcVSaQbPHdkpQJvH");
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c3_Mondmission_get_post_codegen_info();
...
mxArray *sf_c3_Mondmission_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c3_Mondmission_jit_fallback_info(void)
{
...
mxArray *sf_c3_Mondmission_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c3_Mondmission(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"a\",},{M[8],M[0],T\"is_active_c3_Mondmission\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c3_Mondmission_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc3_MondmissionInstanceStruct *) chartInfo->chartInstance;
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        init_script_number_translation(_MondmissionMachineNumber_,
          chartInstance->chartNumber,chartInstance->instanceNumber);
        if (chartAlreadyPresent==0) {
          /* this is the first instance */
          sf_debug_set_chart_disable_implicit_casting
            (sfGlobalDebugInstanceStruct,_MondmissionMachineNumber_,
        ...
        _SFD_SET_DATA_VALUE_PTR(0U, *chartInstance->c3_x0);
        _SFD_SET_DATA_VALUE_PTR(1U, *chartInstance->c3_a);
      }
    } else {
      sf_debug_reset_current_state_configuration(sfGlobalDebugInstanceStruct,
        _MondmissionMachineNumber_,chartInstance->chartNumber,
        chartInstance->instanceNumber);
    }
  }
}
...
{
  return "mrH7oQXciTfF2X6XvhYi7B";
}

static void sf_opaque_initialize_c3_Mondmission(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc3_MondmissionInstanceStruct*) chartInstanceVar)
    ->S,0);
  initialize_params_c3_Mondmission((SFc3_MondmissionInstanceStruct*)
    chartInstanceVar);
  initialize_c3_Mondmission((SFc3_MondmissionInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c3_Mondmission(void *chartInstanceVar)
{
  enable_c3_Mondmission((SFc3_MondmissionInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c3_Mondmission(void *chartInstanceVar)
{
  disable_c3_Mondmission((SFc3_MondmissionInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c3_Mondmission(void *chartInstanceVar)
{
  sf_gateway_c3_Mondmission((SFc3_MondmissionInstanceStruct*) chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c3_Mondmission(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  return get_sim_state_c3_Mondmission((SFc3_MondmissionInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c3_Mondmission(SimStruct* S, const mxArray
  *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  set_sim_state_c3_Mondmission((SFc3_MondmissionInstanceStruct*)
    chartInfo->chartInstance, st);
}

static void sf_opaque_terminate_c3_Mondmission(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc3_MondmissionInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
      unload_Mondmission_optimization_info();
    }

    finalize_c3_Mondmission((SFc3_MondmissionInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc3_Mondmission((SFc3_MondmissionInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c3_Mondmission(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c3_Mondmission(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct = load_Mondmission_optimization_info();
  ...
  ssSetChecksum0(S,(3033657858U));
  ssSetChecksum1(S,(1211705835U));
  ssSetChecksum2(S,(1040898222U));
  ssSetChecksum3(S,(3089286166U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c3_Mondmission(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c3_Mondmission(SimStruct *S)
{
  SFc3_MondmissionInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc3_MondmissionInstanceStruct *)utMalloc(sizeof
    (SFc3_MondmissionInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc3_MondmissionInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c3_Mondmission;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c3_Mondmission;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c3_Mondmission;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c3_Mondmission;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c3_Mondmission;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c3_Mondmission;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c3_Mondmission;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c3_Mondmission;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c3_Mondmission;
  chartInstance->chartInfo.mdlStart = mdlStart_c3_Mondmission;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c3_Mondmission;
...
void c3_Mondmission_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c3_Mondmission(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c3_Mondmission(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c3_Mondmission(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c3_Mondmission_method_dispatcher.\n"
